import { mergeProps, useSSRContext } from 'file://C:/Users/home/source/repos/SmokeSenac/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrInterpolate } from 'file://C:/Users/home/source/repos/SmokeSenac/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-223c6ca9><div class="-bottom-1/2 fixed h-1/2 left-0 right-0 spotlight" data-v-223c6ca9></div><div class="max-w-520px text-center" data-v-223c6ca9><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-223c6ca9>${ssrInterpolate(__props.statusCode)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-223c6ca9>${ssrInterpolate(__props.description)}</p></div></div>`);
    };
  }
};
...
const error500 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-223c6ca9"]]);

export { error500 as default };
//# sourceMappingURL=error-500-D5qzI_AX.mjs.map
