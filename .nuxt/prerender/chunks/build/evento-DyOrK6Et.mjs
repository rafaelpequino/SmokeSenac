...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<section${ssrRenderAttrs(mergeProps({ id: "event" }, _attrs))} data-v-1a0abe12><div id="inside-event" data-v-1a0abe12><h1 class="page-title" data-v-1a0abe12>Evento</h1><div class="event-info" data-v-1a0abe12><div class="event-picture" data-v-1a0abe12><img${ssrRenderAttr("src", _imports_0)} alt="Banner do evento Robocar Race -&gt; 3\xBA Competi\xE7\xE3o Brasileira de Ve\xEDculos Aut\xF4nomos em Escala. Novembro 2024. Inscreva-se. Gr\xE1tis e aberto para estudantes, pesquisadores, hobbistas, makers e entusiastas." data-v-1a0abe12></div><div class="event-data" data-v-1a0abe12><p data-v-1a0abe12> Neste ano, a cidade de Santo Andr\xE9 foi palco da 3\xAA edi\xE7\xE3o da RobocarRace, realizada no A.A.C.D do ABC. O evento destacou-se por promover competi\xE7\xF5es entre carrinhos aut\xF4nomos, que utilizam tecnologias de vis\xE3o computacional e sensores ultrass\xF4nicos para navega\xE7\xE3o e tomada de decis\xF5es. A competi\xE7\xE3o foi dividida em tr\xEAs modalidades, cada uma com suas pr\xF3prias caracter\xEDsticas e desafios: </p><br data-v-1a0abe12><p data-v-1a0abe12><strong data-v-1a0abe12>Mini</strong>: Pista compacta, projetada pelos alunos do SENAC. A estrutura foi constru\xEDda em MDF cortado a laser. </p><p data-v-1a0abe12><strong data-v-1a0abe12>J\xFAnior</strong>: Percurso reduzido, mas com a adi\xE7\xE3o de cones coloridos para orientar a navega\xE7\xE3o dos carrinhos. </p><p data-v-1a0abe12><strong data-v-1a0abe12>Master</strong>: Percurso completo inspirado no estilo de corrida da F\xF3rmula 1. </p><br data-v-1a0abe12><p data-v-1a0abe12> A RobocarRace n\xE3o apenas promoveu a inova\xE7\xE3o tecnol\xF3gica e o aprendizado pr\xE1tico, mas tamb\xE9m estimulou a criatividade e a colabora\xE7\xE3o entre os participantes, reafirmando seu papel como um dos principais eventos de rob\xF3tica da regi\xE3o. </p><a href="https://www.robocarrace.com.br/" target="_blank" data-v-1a0abe12>Saiba Mais</a></div></div></div></section>`);
}
...
//# sourceMappingURL=evento-DyOrK6Et.mjs.map
