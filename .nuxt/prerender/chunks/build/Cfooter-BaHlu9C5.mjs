...
import { ssrRenderAttrs, ssrRenderAttr } from 'file://C:/Users/home/source/repos/SmokeSenac/node_modules/vue/server-renderer/index.mjs';
...
const _imports_0 = "" + buildAssetsURL("logo_smoke_footer_sf.BzGkELtA.png");
const _sfc_main = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<footer${ssrRenderAttrs(mergeProps({ id: "footer" }, _attrs))} data-v-3bed2928><div id="inside-footer" data-v-3bed2928><div class="link-img-footer" data-v-3bed2928><img${ssrRenderAttr("src", _imports_0)} alt="Logo do grupo &#39;Smoke&#39; - Grupo do 2\xBA semestre do curso de Engenharia de Computa\xE7\xE3o do centro universit\xE1rio Senac Santo Amaro" data-v-3bed2928></div></div></footer>`);
}
...
//# sourceMappingURL=Cfooter-BaHlu9C5.mjs.map
